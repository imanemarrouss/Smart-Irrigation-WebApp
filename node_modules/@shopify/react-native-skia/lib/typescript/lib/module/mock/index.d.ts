export function Mock(CanvasKit: any): {
    ...
    useSVG: () => null;
    useVideo: () => null;
    JsiDrawingContext: typeof import("../dom/types").JsiDrawingContext;
    composeDeclarations: (filters: any, composer: any) => any;
    DeclarationContext: typeof import("../dom/types").DeclarationContext;
    NodeType: {};
    ...
    processCircle: (Skia: any, def: any) => any;
